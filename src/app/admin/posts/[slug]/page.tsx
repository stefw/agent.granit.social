...
export const metadata: Metadata = {
  title: 'Administration - Éditer un post',
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold">Éditer le post</h1>
          <p className="text-gray-500 mt-2">
            Modifiez votre post en Markdown et ajoutez des médias (images, audio)
          </p>
        </div>
